// RUTA: shared/ui/src/lib/components/DropdownMenu.tsx
/**
 * @file DropdownMenu.tsx
 * @description Sistema de componentes para menús desplegables.
...
>(({ className, inset, children, ...props }, ref) => {
  ...
  logger.trace("[DropdownMenu] Renderizando SubTrigger v3.0.");
  return (
    ...
    >
      {children}
      <DynamicIcon name="ChevronRight" className="ml-auto h-4 w-4" />
    </DropdownMenuPrimitive.SubTrigger>
  );
});
...
>(({ className, ...props }, ref) => {
  logger.trace("[DropdownMenu] Renderizando SubContent v3.0.");
  return (
...
>(({ className, sideOffset = 4, ...props }, ref) => {
  logger.trace("[DropdownMenu] Renderizando Content v3.0.");
  return (
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
      <DropdownMenuPrimitive.ItemIndicator>
        <DynamicIcon name="Circle" className="h-2 w-2 fill-current" />
      </DropdownMenuPrimitive.ItemIndicator>
    </span>
    {children}
  </DropdownMenuPrimitive.RadioItem>
